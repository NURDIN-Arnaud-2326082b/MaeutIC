...
class ReportApiController extends AbstractController
{
    ...
    public function create(
        ...
        if (!$this->targetExists($targetType, $targetId, $postRepository, $commentRepository, $userRepository, $messageRepository)) {
            return $this->json(['error' => 'Contenu non trouve'], Response::HTTP_NOT_FOUND);
        }

        if ($this->isOwnTarget($currentUser, $targetType, $targetId, $postRepository, $commentRepository, $messageRepository)) {
