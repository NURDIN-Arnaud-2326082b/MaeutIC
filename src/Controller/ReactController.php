...
class ReactController extends AbstractController
{
    ...
    #[Route(
        ...
        requirements: [
            ...
            'reactRouting' => '(?!api(?:/|$))(?!react(?:/|$))(?!assets(?:/|$))(?!js(?:/|$))(?!images(?:/|$))(?!audio(?:/|$))(?!article_images(?:/|$))(?!article_pdfs(?:/|$))(?!author_images(?:/|$))(?!book_images(?:/|$))(?!post_images(?:/|$))(?!post_pdfs(?:/|$))(?!profile_images(?:/|$))(?!logo-maieutic.*\.png$)(?!mode-(?:lumiere|nuit)\.png$)(?!clusters\.json$)(?!thesis-dashboard-data\.json$)(?!manifest\.json$)(?!sw\.js$)(?!favicon\.ico$)(?!robots\.txt$)(?!.*\.[a-zA-Z0-9]+$).*',
        ],
        methods: ['GET'],
        priority: -1
    )]
