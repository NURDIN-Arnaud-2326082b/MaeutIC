...
export default function Register() {
  ...
  const [formData, setFormData] = useState({
    ...
    specialization: '',
    researchTopic: '',
    mandatoryQuestions: ['', '', ''], // Nouvel état pour les 3 questions obligatoires
    taggableQuestions: [[], []],
    userQuestions: Array(10).fill('') // Ajusté à 10 pour correspondre aux DYNAMIC_QUESTIONS restantes
  })
  ...
  const handleSubmit = (e) => {
    ...
    // Ajout des nouvelles questions obligatoires à envoyer au backend
    formDataToSend.append('mandatoryQuestions', JSON.stringify(formData.mandatoryQuestions))
  ...
  // Fonction utilitaire pour rendre une question taggable afin d'éviter la duplication de code
  const renderTaggableQuestion = (index) => (
      <div className="taggable-question mt-5 group">
        <label className="block text-sm font-semibold text-gray-700 mb-1">
          {TAGGABLE_QUESTIONS[index]}
          {MIN_TAGS_REQUIRED[index] > 0 && <span className="text-red-500">*</span>}
          {MIN_TAGS_REQUIRED[index] > 0 && (
        ...
        <div className="relative w-full">
          <input
              ...
              placeholder="Rechercher un mot-clé (appuyez sur Entrée)..."
              autoComplete="off"
          />
        </div>
          ...
          >
            <div className="space-y-5">
              ...
              <div className="mt-10 pt-6 border-t border-gray-200">
                    ...
                    <div key={`mandatory-${index}`} className="mt-5 group">
                      ...
                      <textarea
                          ...
                          onChange={(e) => {
                            ...
                            setFormData({ ...formData, mandatoryQuestions: newQuestions })
                          }}
                          rows={3}
                ...
                {/* Première question avec tags (Obligatoire) */}
              ...
              <div className="mt-10 pt-6 border-t border-gray-200">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Pour aller plus loin, vous pouvez répondre à ces questions optionnelles :
                </p>

                {/* Deuxième question avec tags (Devenue optionnelle) */}
                {renderTaggableQuestion(1)}

                {/* Les questions dynamiques restantes */}
                ...
                {/* Compteur de questions optionnelles répondues */}
                {answeredQuestionsCount > 0 && (
                    ...
                    </span> question(s) optionnelle(s) complétée(s)
                      </p>
                    </div>
                )}
