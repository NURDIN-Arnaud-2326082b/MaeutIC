...
final class VersionS20250911093410 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Autorise les id users nuls dans les différentes entités et ajoute des contraintes de suppression en cascade';
    }
